...
- 近接攻撃用のスタミナとオーバーヒートを追加。3回攻撃するとスタミナが0になり、最大まで回復するまで近接攻撃できない。
...
13. Fキーを3回使い、スタミナが0になってオーバーヒートするか確認する。
14. Shiftキーで左右ステップできるか確認する。
15. ステップ中の短い無敵時間で、単発の被弾を避けられるか確認する。
16. 次に弾薬所持数、近接武器データ化、または敵遠距離攻撃の土台へ進む。
